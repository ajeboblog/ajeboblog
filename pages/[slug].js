...
const PopularPost = dynamic(() => import('../src/containers/category/component/popularpost2'))
const RecentPost = dynamic(() => import('../src/containers/category/component/recent'))
...
import Footer from '../src/assets/Footer3'
...
class Post extends Component {
  ...
  static async getInitialProps(context) {
    let { query } = context
    const data =  await axios.get(`https://joydimba.herokuapp.com/api/blog/blog/${query.slug}`)
